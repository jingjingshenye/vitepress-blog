...
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">});</span></span>
<span class="line"><span style="color:#24292E;">&lt;/script&gt;</span></span></code></pre></div><h2 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-label="Permalink to &quot;注意事项&quot;">​</a></h2><p>开启 JWT 后，需要 token 验证，要请求自建的后端服务获取 token。</p><p>这里建议 config 和 token 一起下发，后端配置更加灵活，不需要前端发版</p><p>访问 docker 用主机 ip+映射接口，本地自建服务器也要用真实 ip</p>`,10),e=[o];function c(t,r,E,y,i,d){return n(),a("div",null,e)}const m=s(p,[["render",c]]);export{u as __pageData,m as default};
