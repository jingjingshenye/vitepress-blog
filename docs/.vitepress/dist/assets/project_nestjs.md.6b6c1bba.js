import{_ as a,o as n,c as p,Q as s,k as l}from"./chunks/framework.9f730de1.js";const g=JSON.parse('{"title":"nestjs","description":"","frontmatter":{},"headers":[],"relativePath":"project/nestjs.md","filePath":"project/nestjs.md"}'),e={name:"project/nestjs.md"},o=s(`<h1 id="nestjs" tabindex="-1">nestjs <a class="header-anchor" href="#nestjs" aria-label="Permalink to &quot;nestjs&quot;">​</a></h1><h2 id="快速生成项目" tabindex="-1">快速生成项目 <a class="header-anchor" href="#快速生成项目" aria-label="Permalink to &quot;快速生成项目&quot;">​</a></h2><p>快速生成 项目</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 全局安装脚手架</span></span>
...
<span class="line"><span style="color:#24292e;">npm install --save @nestjs/typeorm typeorm mysql2</span></span></code></pre></div><h2 id="文件说明" tabindex="-1">文件说明 <a class="header-anchor" href="#文件说明" aria-label="Permalink to &quot;文件说明&quot;">​</a></h2><p>app.controller.spec.ts：这是一个用作测试的文件</p><p>app.controller.ts：这是一个控制器文件</p><p>app.module.ts: 这是根模块文件</p><p>app.service.ts：这是一个提供功能服务的文件</p><p>main.ts：这是 nest 项目的入口文件</p><h2 id="原理" tabindex="-1">原理 <a class="header-anchor" href="#原理" aria-label="Permalink to &quot;原理&quot;">​</a></h2><ol><li>通过装饰器给 class 或者对象添加元数据，然后初始化的时候取出这些元数据，进行依赖的分析，然后创建对应的实例对象就可以了</li><li>实现的核心就是 Reflect metadata 的 api</li><li>通过装饰器给 class 或者对象添加 metadata，并且开启 ts 的 emitDecoratorMetadata 来自动添加类型相关的 metadata，然后运行的时候通过这些元数据来实现依赖的扫描，对象的创建等等功能。</li></ol>`,20),t=l("p",{"controllers:":"","[],providers:":"","[]":""},"首先 @modules({ controllers: [], providers: [] }) 收集了所有的 controllers，和 providers 装在一个对象上（其实是借用了 reflect meatadataAPI）我可以理解为：const factory =",-1),c=s(`<p>然后 controllers 里的所有类，的参数都来自 providers，所以我们在 controllers 里每一个类的时候，是不是只要找到对应 providers 里的参数，就自动实例化了？provider 我们是不是在 factory 里已经有</p><p>这里的问题就剩下说，如何之后每个 controller 依赖了哪些 provider，这个又是 reflect meatadataAPI 帮我们解决了，所以这就是整体的思路</p><h2 id="部署" tabindex="-1">部署 <a class="header-anchor" href="#部署" aria-label="Permalink to &quot;部署&quot;">​</a></h2><p>项目根目录创建 Dockerfile</p><div class="language-dockerfile vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dockerfile</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 使用Node.js作为基础镜像</span></span>
